                ...
                <div class="clearfix">
                    <div class="content_l">
                        <form id="companyListForm" name="companyListForm" method="get" action="<?php echo U('Home/Index/search');?>">
                            <input type="hidden" id="city" name="city" value="<?php echo ($citySelect); ?>" />
                            <input type="hidden" id="fs" name="fs" value="<?php echo ($stageSelect); ?>" />
                            <input type="hidden" id="ifs" name="ifs" value="<?php echo ($tradeSelect); ?>" />
                            ...
                            <dl class="hc_tag">
                                <dt>
                                    ...
                                    <ul class="workplace reset fr" id="workplaceSelect">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)" <?php if ($_GET['city'] == $hotVal) echo 'class="current"'; ?>><?php echo ($hotVal); ?></a> |
                                        </li>
                                        <?php endforeach ;?>
                                        <li class="more">
                                        ...
                                        <li id="box_expectCity" class="searchlist_expectCity dn">
                                            ...
                                            <dl>
                                                ...
                                                <dd>
                                                    ...
                                                    <span <?php if ($_GET['city'] == $Val) echo 'class="current"'; ?>><?php echo ($val); ?></span>
                                                    <?php endforeach ;?>
                                                </dd>
                                            </dl>
                                            <?php endforeach; ?>
                                ...
                                <dd>
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            <a href="javascript:void(0)" <?php if ($_GET['fs'] == $stageVal) echo 'class="current"'; ?>><?php echo ($stageVal); ?></a>
                                            <?php endforeach; ?>
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>行业领域：</dt>
                                        <dd>
                                            <?php if(is_array($trade)): foreach($trade as $key=>$tradeVal): ?><a href="javascript:void(0)" <?php if ($_GET['ifs'] == $tradeVal['name']) echo 'class="current"'; ?>><?php echo ($tradeVal["name"]); ?></a><?php endforeach; endif; ?>
                                        </dd>
                                    </dl>
                                </dd>
                            </dl>
