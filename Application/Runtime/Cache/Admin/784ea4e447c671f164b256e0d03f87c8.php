				...
				<tr>
					...
					<td>
						<div class="hidden-phone visible-desktop action-buttons">
							...
							<a href="javascript:;" class="red uncheck tooltip-info no-hover-underline" data-rel="tooltip" data-original-title="不通过" data-id="<?php echo ($val["id"]); ?>" onclick=uncheck(<?php echo ($val["id"]); ?>)>
								<i class="icon-legal bigger-130"></i>
							</a>
						</div>
					</td>
