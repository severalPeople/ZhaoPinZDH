...
<div class="row-fluid">
								...
								<li class="dd-item" data-id="<?php echo ($v["id"]); ?>">
									<div class="dd-handle">
										...
										<div class="pull-right action-buttons">
											<a href="javascript:$.lagou.formShow('<?php echo U('Admin/Type/edit', array('id'=>$v['id']));?>');" class="blue">
	...
	<div class="span1">
		<a style="position:fixed;" class="btn btn-app btn-success" href="javascript:$.lagou.formShow('<?php echo U('Admin/Type/add');?>');">
			<i class="icon-plus-sign bigger-230"></i>添加分类
		</a>
	</div>
</div>
