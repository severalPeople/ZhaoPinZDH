...
<html lang="en">
	...
	<ul class="nav nav-list">
		<li <?php if(manager == 'index'): ?>class="active open"<?php endif; ?>>
		...
		<li <?php if(manager == 'user'): ?>class="active open"<?php endif; ?>>
		...
		<li <?php if(manager == 'company'): ?>class="active open"<?php endif; ?>>
			<a href="javascript:;" class="dropdown-toggle">
		...
		<li <?php if(manager == 'type'): ?>class="active open"<?php endif; ?>>
			<a href="javascript:;" class="dropdown-toggle">
				<i class="icon-film"></i>
		...
		<li <?php if(manager == 'link'): ?>class="active open"<?php endif; ?>>
			<a href="javascript:;" class="dropdown-toggle">
		...
		<li <?php if(manager == 'manager'): ?>class="active open"<?php endif; ?>>
			<a href="javascript:;" class="dropdown-toggle">
...
<div class="row-fluid">
	<h3 class="header blue lighter smaller">
		<form action="<?php echo U('Admin/Manager/index');?>" method="get">
		<div class="row-fluid  dataTables_wrapper">
			<div class="span4">
				<button class="btn btn-primary btn-small" onclick="$.lagou.formShow('<?php echo U('Admin/Manager/add');?>');" type="button"><i class="icon-plus"></i>创建管理员</button>
			</div>
		...
		<tbody>
			<?php foreach ($data as $key => $value): ?>
				<tr>
					...
					<td class="hidden-480">
						<img src="<?php echo oj_admin_logo($value['id'], $value['image']);?>" style="width:32px;height:32px;" />
					</td>
					<td><?php echo (date("Y-m-d H:i", $value["create_time"])); ?></td>
					<td><?php echo (date("Y-m-d H:i", $value["login_time"])); ?> / <?php echo ((isset($value["login_ip"]) && ($value["login_ip"] !== ""))?($value["login_ip"]):"暂未登录"); ?></td>
					<td>
					...
					<td>
						<div class="hidden-phone visible-desktop action-buttons">
							<a href="javascript:;" onclick="$.lagou.formShow('<?php echo U('Admin/Manager/edit', array('user_id'=>$value['id']));?>');" class="blue tooltip-info no-hover-underline" data-rel="tooltip" data-original-title="编辑资料">
								<i class="icon-pencil bigger-130"></i>
							</a>
							<a href="javascript:;" onclick="$.del('<?php echo U('Admin/Manager/del', array('user_id'=>$value['id']));?>');" class="red tooltip-error no-hover-underline" data-rel="tooltip" data-original-title="删除管理员"><i class="icon-trash bigger-130"></i></a>
						</div>
					</td>
				</tr>
			<?php endforeach ?>
